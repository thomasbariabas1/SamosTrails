...
public class TrailDb {
    ...
    public static void insertIntoDb(Trail trail, TrailDbHelper mDbHelper){
...
// How you want the results sorted in the resulting Cursor
        ...
        while(cursor.moveToNext()) {
             trail=new Trail(Boolean.parseBoolean(cursor.getString(cursor.getColumnIndexOrThrow(TrailEntry.COLUMN_NAME_CHILDRENFRIENDLY))) ,
